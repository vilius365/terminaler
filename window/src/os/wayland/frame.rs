...
use terminaler_font::{FontConfiguration, FontMetrics, GlyphInfo, RasterizedGlyph};
use terminaler_input_types::WindowDecorations;
    ...
    fn reshape_title(&mut self) -> Option<()> {
        ...
        let infos = font
            .shape(
                ...
                None,
                terminaler_surface::bidi_stub::Direction::LeftToRight,
                None,
                None,
            )
            .ok()?;
