...
pub use terminaler_char_props::emoji::Presentation;
use terminaler_char_props::emoji_variation::WCWIDTH_TABLE;
use terminaler_char_props::widechar_width::WcWidth;
use terminaler_dynamic::{FromDynamic, ToDynamic};
pub use terminaler_escape_parser::osc::Hyperlink;
...
pub use terminaler_escape_parser::csi::{Blink, Intensity, Underline, VerticalAlign};
...
pub fn is_white_space_char(c: char) -> bool {
    terminaler_char_props::white_space::WHITE_SPACE.contains_u32(c as u32)
}
...
///
/// The approach that terminaler wants to take here is to define a
...
mod test {
    ...
    // See <https://github.com/wez/wezterm/issues/6637>
    ...
    // That decision is made over in terminaler-term when processing
    ...
    fn issue_6637() {
        ...
        // due to <https://github.com/wez/wezterm/issues/1422>.
